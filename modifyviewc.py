...
# Form implementation generated from reading ui file 'modifyview.ui'
#
...
class Ui_modifyview(object):
    def printing(self):
        self.exit.setVisible(False)
        self.forprint.setVisible(False)
        self.label_3.setVisible(False)
        self.label_2.setVisible(False)
        self.label.setPixmap(QtGui.QPixmap("background-image:transparent"))
        s=QtWidgets.QWidget.grab(self.modifyview33,rectangle=QtCore.QRect(QtCore.QPoint(0, 0), QtCore.QSize(680, 511)))
        self.label.setPixmap(QtGui.QPixmap(":/newPrefix/ttt.jpg"))
        self.label_2.setVisible(True)
        self.label_3.setVisible(True)
        self.exit.setVisible(True)
        self.forprint.setVisible(True)
    ...
    def cancel1(self):
        ...
        self.window.show()
        self.modifyview33.hide()
    def setupUi(self, modifyview):
        self.modifyview33=modifyview
        modifyview.setObjectName("modifyview")
        modifyview.resize(717, 531)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(modifyview.sizePolicy().hasHeightForWidth())
        modifyview.setSizePolicy(sizePolicy)
        modifyview.setMinimumSize(QtCore.QSize(717, 531))
        modifyview.setMaximumSize(QtCore.QSize(717, 531))
        self.centralwidget = QtWidgets.QWidget(modifyview)
...
"")
        ...
        self.forprint = QtWidgets.QPushButton(self.centralwidget)
        self.forprint.setGeometry(QtCore.QRect(30, 450, 31, 31))
        font = QtGui.QFont()
        font.setFamily("Palatino Linotype")
        font.setPixelSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.forprint.setFont(font)
        self.forprint.setAcceptDrops(False)
        self.forprint.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"background-image: url(:/newPrefix/how-to-print-png-files-4-original (1).png);")
        self.forprint.setText("")
        self.forprint.setCheckable(False)
        self.forprint.setDefault(False)
        self.forprint.setFlat(True)
        self.forprint.setToolTip("print")
        self.forprint.setObjectName("forprint")
        ...
        modifyview.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(modifyview)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 717, 21))
        self.menubar.setObjectName("menubar")
        modifyview.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(modifyview)
        self.statusbar.setObjectName("statusbar")
        modifyview.setStatusBar(self.statusbar)
        #===============
        self.detail()
        ...
        self.exit.clicked.connect(self.cancel1)
        self.forprint.clicked.connect(self.printing)
        #==================
        self.retranslateUi(modifyview)
        QtCore.QMetaObject.connectSlotsByName(modifyview)
        modifyview.setTabOrder(self.forprint, self.exit)

    def retranslateUi(self, modifyview):
        _translate = QtCore.QCoreApplication.translate
        modifyview.setWindowTitle(_translate("modifyview", "View details"))
        self.add.setText(_translate("modifyview", "UPDATED SUCCESSFULLY      ."))
        self.label_3.setText(_translate("modifyview", "admin"))
        self.label_4.setText(_translate("modifyview", "NAME                        :"))
        self.label_10.setText(_translate("modifyview", "ADDRESS                :"))
        self.label_12.setText(_translate("modifyview", "DIVISION                 :"))
        self.label_13.setText(_translate("modifyview", "CLASS                       :"))
        self.label_14.setText(_translate("modifyview", "ROLLNO                   :"))
        self.exit.setText(_translate("modifyview", "BACK"))
        self.label_11.setText(_translate("modifyview", "EMAIL ID                 :"))
        self.label_15.setText(_translate("modifyview", "PHONE NO             :"))
        self.label_16.setText(_translate("modifyview", "D.O.B                         :"))
        self.label_17.setText(_translate("modifyview", "CLASS TEACHER   :"))
        self.label_5.setText(_translate("modifyview", "ADMN NO               :"))
import pic
...
if __name__ == "__main__":
    ...
    modifyview = QtWidgets.QMainWindow()
    ui = Ui_modifyview()
    ui.setupUi(modifyview)
    modifyview.show()
    sys.exit(app.exec_())
