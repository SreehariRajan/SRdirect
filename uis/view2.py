...
class Ui_view2(object):
    def setupUi(self, view2):
        ...
        self.label.setGeometry(QtCore.QRect(0, -30, 751, 551))
        self.label.setFrameShadow(QtWidgets.QFrame.Plain)
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/newPrefix/plain-white-background.jpg"))
...
"")
        ...
        self.address.setGeometry(QtCore.QRect(200, 350, 231, 151))
        font = QtGui.QFont()
        font.setFamily("Myanmar Text")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.forprint.setGeometry(QtCore.QRect(40, 440, 31, 31))
        font = QtGui.QFont()
        font.setFamily("Palatino Linotype")
        font.setPointSize(11)
        font.setBold(True)
...
"background-image: url(:/newPrefix/how-to-print-png-files-4-original (1).png);")
    ...
    def retranslateUi(self, view2):
        ...
        view2.setWindowTitle(_translate("view2", "MainWindow"))
        ...
        self.exit.setText(_translate("view2", "EXIT"))
