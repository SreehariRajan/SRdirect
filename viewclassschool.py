...
class Ui_viewclass(object):
    ...
    def classviewing(self):
        retrieve.view03school()
        for row_number,row_data in enumerate(retrieve.resultschool):
    ...
    def namesorting(self):
        ...
        for i in l:
            c+=i     
        retrieve.namesorting1school(c.lower())
        for row_number,row_data in enumerate(retrieve.result1school):
            self.tableView.insertRow(row_number)
            for column_number,column_data in enumerate(row_data):
                if column_number!=1:
