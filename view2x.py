...
class Ui_view2(object):
    def printing(self):
        ...
        s=QtWidgets.QWidget.grab(self.view22,rectangle=QtCore.QRect(QtCore.QPoint(50, 50), QtCore.QSize(630, 461)))
