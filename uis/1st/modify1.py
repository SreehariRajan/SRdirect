...
# Form implementation generated from reading ui file 'modify1.ui'
#
...
class Ui_modify_4(object):
    def setupUi(self, modify_4):
        modify_4.setObjectName("modify_4")
        modify_4.resize(601, 354)
        self.centralwidget = QtWidgets.QWidget(modify_4)
...
"")
        ...
        modify_4.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(modify_4)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 601, 21))
        self.menubar.setObjectName("menubar")
        modify_4.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(modify_4)
        self.statusbar.setObjectName("statusbar")
        modify_4.setStatusBar(self.statusbar)

        self.retranslateUi(modify_4)
        QtCore.QMetaObject.connectSlotsByName(modify_4)

    def retranslateUi(self, modify_4):
        _translate = QtCore.QCoreApplication.translate
        modify_4.setWindowTitle(_translate("modify_4", "MainWindow"))
        self.add.setText(_translate("modify_4", "MODIFY"))
        self.label_3.setText(_translate("modify_4", "admin"))
        self.label_13.setText(_translate("modify_4", "ADMN NO"))
        self.cancel.setText(_translate("modify_4", "Cancel"))
        self.submit.setText(_translate("modify_4", "Submit"))
import pic_rc
...
if __name__ == "__main__":
    ...
    modify_4 = QtWidgets.QMainWindow()
    ui = Ui_modify_4()
    ui.setupUi(modify_4)
    modify_4.show()
    sys.exit(app.exec_())
