...
# Form implementation generated from reading ui file 'del3.ui'
#
...
import retrieve,dialogdelc,mod1,head,del1

class Ui_del3(object):
    def inchange(self):
    ...
    def forcrup(self):
        ...
        if len(rll)!=0 and len(cls2)!=0 and len(divsn)!=0:
            if rll.isdigit()==True and divsn.isalpha()==True:
                if cls2.isdigit()==True or cls2.lower() in ['lkg','ukg']:
                    if retrieve.classstudent(cls2.lower(),divsn.lower(),int(rll))==True:
                        ...
                        head.deletedetail(int(rll),cls2.lower(),divsn.lower())
                        self.invalid_3.setText("")
                        self.window=QtWidgets.QMainWindow()
                        self.ui=dialogdelc.Ui_dialogdel()
                        self.ui.setupUi(self.window)
                        self.window.show()
                        self.del3.hide()
                    else:  
    ...
    def setupUi(self, del3):
        ...
        sizePolicy.setHeightForWidth(del3.sizePolicy().hasHeightForWidth())
        del3.setSizePolicy(sizePolicy)
        del3.setMinimumSize(QtCore.QSize(601, 354))
        del3.setMaximumSize(QtCore.QSize(601, 354))
        self.centralwidget = QtWidgets.QWidget(del3)
...
"")
        ...
        del3.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(del3)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 601, 21))
        self.menubar.setObjectName("menubar")
        del3.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(del3)
        self.statusbar.setObjectName("statusbar")
        del3.setStatusBar(self.statusbar)

        self.retranslateUi(del3)
        QtCore.QMetaObject.connectSlotsByName(del3)
        del3.setTabOrder(self.class_2, self.division)
        del3.setTabOrder(self.division, self.roll)
        del3.setTabOrder(self.roll, self.submit)
        del3.setTabOrder(self.submit, self.cancel)
        del3.setTabOrder(self.cancel, self.add)
    ...
    def retranslateUi(self, del3):
        _translate = QtCore.QCoreApplication.translate
        del3.setWindowTitle(_translate("del3", "Delete student"))
        self.add.setText(_translate("del3", "DELETE"))
        self.label_3.setText(_translate("del3", "admin"))
        self.label_12.setText(_translate("del3", "DIVISION "))
        self.label_13.setText(_translate("del3", "CLASS       "))
        self.label_14.setText(_translate("del3", "ROLLNO  "))
        self.cancel.setText(_translate("del3", "Back"))
        self.submit.setText(_translate("del3", "Submit"))
import pic
