...
# Form implementation generated from reading ui file 'delete1.ui'
#
...
class Ui_delete_4(object):
    def setupUi(self, delete_4):
        delete_4.setObjectName("delete_4")
        delete_4.resize(601, 354)
        self.centralwidget = QtWidgets.QWidget(delete_4)
...
"")
        ...
        delete_4.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(delete_4)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 601, 21))
        self.menubar.setObjectName("menubar")
        delete_4.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(delete_4)
        self.statusbar.setObjectName("statusbar")
        delete_4.setStatusBar(self.statusbar)

        self.retranslateUi(delete_4)
        QtCore.QMetaObject.connectSlotsByName(delete_4)

    def retranslateUi(self, delete_4):
        _translate = QtCore.QCoreApplication.translate
        delete_4.setWindowTitle(_translate("delete_4", "MainWindow"))
        self.add.setText(_translate("delete_4", "DELETE"))
        self.label_3.setText(_translate("delete_4", "admin"))
        self.label_13.setText(_translate("delete_4", "ADMN NO"))
        self.cancel.setText(_translate("delete_4", "Cancel"))
        self.submit.setText(_translate("delete_4", "Submit"))
import pic_rc
...
if __name__ == "__main__":
    ...
    delete_4 = QtWidgets.QMainWindow()
    ui = Ui_delete_4()
    ui.setupUi(delete_4)
    delete_4.show()
    sys.exit(app.exec_())
