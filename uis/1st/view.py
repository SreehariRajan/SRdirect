...
"")
    ...
    def retranslateUi(self, view_3):
        ...
        view_3.setWindowTitle(_translate("view_3", "MainWindow"))
        self.add.setText(_translate("view_3", "SEARCH"))
        self.label_3.setText(_translate("view_3", "admin"))
        self.label_12.setText(_translate("view_3", "DIVISION "))
        self.label_13.setText(_translate("view_3", "CLASS       "))
        self.label_14.setText(_translate("view_3", "ROLLNO  "))
        self.cancel.setText(_translate("view_3", "Cancel"))
        self.submit.setText(_translate("view_3", "Submit"))
import pic_rc
