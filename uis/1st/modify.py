...
class Ui_modify_3(object):
    def setupUi(self, modify_3):
        modify_3.setObjectName("modify_3")
        modify_3.resize(601, 354)
        self.centralwidget = QtWidgets.QWidget(modify_3)
...
"")
        ...
        modify_3.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(modify_3)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 601, 21))
        self.menubar.setObjectName("menubar")
        modify_3.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(modify_3)
        self.statusbar.setObjectName("statusbar")
        modify_3.setStatusBar(self.statusbar)

        self.retranslateUi(modify_3)
        QtCore.QMetaObject.connectSlotsByName(modify_3)

    def retranslateUi(self, modify_3):
        _translate = QtCore.QCoreApplication.translate
        modify_3.setWindowTitle(_translate("modify_3", "MainWindow"))
        self.add.setText(_translate("modify_3", "MODIFY"))
        self.label_3.setText(_translate("modify_3", "admin"))
        self.label_12.setText(_translate("modify_3", "DIVISION "))
        self.label_13.setText(_translate("modify_3", "CLASS       "))
        self.label_14.setText(_translate("modify_3", "ROLLNO  "))
        self.cancel.setText(_translate("modify_3", "Cancel"))
        self.submit.setText(_translate("modify_3", "Submit"))
import pic_rc
...
if __name__ == "__main__":
    ...
    modify_3 = QtWidgets.QMainWindow()
    ui = Ui_modify_3()
    ui.setupUi(modify_3)
    modify_3.show()
    sys.exit(app.exec_())
