...
class Ui_addview(object):
    def printing(self):
        ...
        s=QtWidgets.QWidget.grab(self.addview,rectangle=QtCore.QRect(QtCore.QPoint(0, 0), QtCore.QSize(680, 511)))
    ...
    def setupUi(self, addview):
        ...
        sizePolicy.setHeightForWidth(addview.sizePolicy().hasHeightForWidth())
        addview.setSizePolicy(sizePolicy)
        addview.setMinimumSize(QtCore.QSize(717, 531))
        addview.setMaximumSize(QtCore.QSize(717, 531))
...
"background-image: url(:/newPrefix/how-to-print-png-files-4-original (1).png);")
        ...
        addview.setTabOrder(self.forprint, self.exit)

    def retranslateUi(self, addview):
        _translate = QtCore.QCoreApplication.translate
        addview.setWindowTitle(_translate("addview", "View details"))
        ...
        self.exit.setText(_translate("addview", "BACK"))
