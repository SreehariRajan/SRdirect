...
# Form implementation generated from reading ui file 'delete0.ui'
#
...
class Ui_delete_2(object):
    ...
    def retranslateUi(self, delete_2):
        ...
        self.add.setText(_translate("delete_2", "DELETE"))
        self.label_3.setText(_translate("delete_2", "admin"))
        self.cancel.setText(_translate("delete_2", "Cancel"))
        self.submit.setText(_translate("delete_2", "Ok"))
        self.adid.setText(_translate("delete_2", "Admn No"))
