...
class Ui_deleteview(object):
    def printing(self):
        ...
        s=QtWidgets.QWidget.grab(self.deleteview56,rectangle=QtCore.QRect(QtCore.QPoint(0, 0), QtCore.QSize(680, 511)))
    ...
    def cancel1(self):
        ...
        self.window.show()
        self.deleteview56.hide()
    def setupUi(self, deleteview):
        self.deleteview56=deleteview
        deleteview.setObjectName("deleteview")
        deleteview.resize(717, 531)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(deleteview.sizePolicy().hasHeightForWidth())
        deleteview.setSizePolicy(sizePolicy)
        deleteview.setMinimumSize(QtCore.QSize(717, 531))
        deleteview.setMaximumSize(QtCore.QSize(717, 531))
...
"background-image: url(:/newPrefix/how-to-print-png-files-4-original (1).png);")
        ...
        deleteview.setTabOrder(self.forprint, self.exit)
    def retranslateUi(self, deleteview):
        _translate = QtCore.QCoreApplication.translate
        deleteview.setWindowTitle(_translate("deleteview", "View details"))
        self.add.setText(_translate("deleteview", "DELETED SUCCESSFULLY      ."))
        ...
        self.exit.setText(_translate("deleteview", "BACK"))
        ...
        self.label_17.setText(_translate("deleteview", "CLASS TEACHER   :"))
        self.label_5.setText(_translate("deleteview", "ADMN NO               :"))
