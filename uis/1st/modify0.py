...
# Form implementation generated from reading ui file 'modify0.ui'
#
...
class Ui_modify_2(object):
    def setupUi(self, modify_2):
        modify_2.setObjectName("modify_2")
        modify_2.resize(510, 313)
        self.centralwidget = QtWidgets.QWidget(modify_2)
        ...
        modify_2.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(modify_2)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 510, 21))
        self.menubar.setObjectName("menubar")
        modify_2.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(modify_2)
        self.statusbar.setObjectName("statusbar")
        modify_2.setStatusBar(self.statusbar)

        self.retranslateUi(modify_2)
        QtCore.QMetaObject.connectSlotsByName(modify_2)

    def retranslateUi(self, modify_2):
        _translate = QtCore.QCoreApplication.translate
        modify_2.setWindowTitle(_translate("modify_2", "MainWindow"))
        self.add.setText(_translate("modify_2", "MODIFY"))
        self.label_3.setText(_translate("modify_2", "admin"))
        self.cancel.setText(_translate("modify_2", "Cancel"))
        self.submit.setText(_translate("modify_2", "Ok"))
        self.adid.setText(_translate("modify_2", "Admn No"))
        self.rollno.setText(_translate("modify_2", "Roll No"))
import pic_rc
...
if __name__ == "__main__":
    ...
    modify_2 = QtWidgets.QMainWindow()
    ui = Ui_modify_2()
    ui.setupUi(modify_2)
    modify_2.show()
    sys.exit(app.exec_())
