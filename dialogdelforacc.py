...
import dialogdelforacc2,menu,head

class Ui_dialogdel(object):
    def yess(self):
        head.removeacc()
        self.window = QtWidgets.QMainWindow()
        self.ui=dialogdelforacc2.Ui_dialogdel()
        self.ui.setupUi(self.window)
        self.window.show()
        self.dialogdel2.hide()
    def noo(self):
        self.window = QtWidgets.QMainWindow()
...
"")
    ...
    def retranslateUi(self, dialogdel):
        ...
        self.label_3.setText(_translate("dialogdel", "Are you sure?"))
        self.label_4.setText(_translate("dialogdel","Access granted" ))
