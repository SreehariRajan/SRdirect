...
# Form implementation generated from reading ui file 'dialogmod.ui'
#
...
import modifyviewc,mod3
class Ui_dialogmod(object):
    def yess(self):
        self.window = QtWidgets.QMainWindow()
        self.ui=modifyviewc.Ui_modifyview()
        self.ui.setupUi(self.window)
        self.window.show()
        self.dialogmod2.hide()
    def noo(self):
        self.window = QtWidgets.QMainWindow()
    ...
    def setupUi(self, dialogmod):
        self.dialogmod2=dialogmod
        dialogmod.setObjectName("dialogmod")
        dialogmod.resize(450, 185)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(dialogmod.sizePolicy().hasHeightForWidth())
        dialogmod.setSizePolicy(sizePolicy)
        dialogmod.setMinimumSize(QtCore.QSize(450, 185))
        dialogmod.setMaximumSize(QtCore.QSize(450, 185))
        self.label = QtWidgets.QLabel(dialogmod)
        self.label.setGeometry(QtCore.QRect(-10, -10, 491, 261))
        self.label.setStyleSheet("background-color: rgb(247, 247, 247);")
        self.label.setText("")
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(dialogmod)
        ...
        self.label_3 = QtWidgets.QLabel(dialogmod)
...
"")
        ...
        self.label_4 = QtWidgets.QLabel(dialogmod)
...
"")
        ...
        dialogmod.setTabOrder(self.yes, self.no)

    def retranslateUi(self, dialogmod):
        _translate = QtCore.QCoreApplication.translate
        dialogmod.setWindowTitle(_translate("dialogmod", "Confirm"))
        self.label_3.setText(_translate("dialogmod", "Do you want to see the details ?"))
        self.label_4.setText(_translate("dialogmod", "Updated successfully."))
        self.yes.setText(_translate("dialogmod", "Yes"))
        self.no.setText(_translate("dialogmod", "No"))
import pic
...
if __name__ == "__main__":
    ...
    dialogmod = QtWidgets.QDialog()
    ui = Ui_dialogmod()
    ui.setupUi(dialogmod)
    dialogmod.show()
    sys.exit(app.exec_())
