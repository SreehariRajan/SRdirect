...
"")
    ...
    def retranslateUi(self, view_5):
        ...
        view_5.setWindowTitle(_translate("view_5", "MainWindow"))
        self.label_3.setText(_translate("view_5", "admin"))
        self.label_4.setText(_translate("view_5", "NAME                        :"))
        self.label_10.setText(_translate("view_5", "ADDRESS               :"))
        self.label_12.setText(_translate("view_5", "DIVISION                 :"))
        self.label_13.setText(_translate("view_5", "CLASS                       :"))
        self.label_14.setText(_translate("view_5", "ROLLNO                   :"))
        self.exit.setText(_translate("view_5", "EXIT"))
        self.label_11.setText(_translate("view_5", "EMAIL ID                 :"))
        self.label_15.setText(_translate("view_5", "PHONE NO             :"))
        self.label_16.setText(_translate("view_5", "D.O.B                         :"))
        self.label_17.setText(_translate("view_5", "CLASS TEACHER :"))
        self.label_5.setText(_translate("view_5", "ADMN NO               :"))
        self.add_2.setText(_translate("view_5", "SEARCH"))
import pic_rc
