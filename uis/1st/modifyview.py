...
"")
    ...
    def retranslateUi(self, modifyview):
        ...
        modifyview.setWindowTitle(_translate("modifyview", "MainWindow"))
        self.add.setText(_translate("modifyview", "MODIFIED SUCCESSFULLY   ."))
        ...
        self.exit.setText(_translate("modifyview", "EXIT"))
